import {Badge, Button, Table, TableContainer, Tbody, Td, Th, Thead, Tr, useToast,} from "@chakra-ui/react";
import {installService, removeService, useServicesList, winswCommand,} from "../api/services.ts";
import {MdAddCircleOutline, MdDeleteOutline, MdInstallDesktop, MdOutlineRefresh,} from "react-icons/md";
